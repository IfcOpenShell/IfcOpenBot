...
choco install visualstudio2019buildtools -y --package-parameters "--allWorkloads --includeRecommended --includeOptional --passive" --execution-timeout 7200
...
PYV = ["3.9.13", "3.10.10", "3.11.8", "3.12.1", "3.13.0"]
